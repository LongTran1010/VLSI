...
HD_PWD='C:/Users/longt/Downloads/VLSI/Assignment/VLSI_Assignment/VLSI_Assignment.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RISC_FP.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RISC_FP.tcl

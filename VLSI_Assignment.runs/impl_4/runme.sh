...
HD_PWD='C:/Users/longt/Downloads/VLSI/Assignment/VLSI_Assignment/VLSI_Assignment.runs/impl_4'
cd "$HD_PWD"
...
EAStep vivado -log RISC_FP.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source RISC_FP.tcl -notrace
